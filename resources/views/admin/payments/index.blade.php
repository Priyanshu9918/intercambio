...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4">
                <a href="{{ route('admin.payments.create') }}" class="btn btn-primary">Add Payments</a>
            </h4>
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            if ($("#payments-datatable").length > 0) {
                /*Checkbox Add*/
                var tdCnt = 0;
                var targetDt = $('#payments-datatable').DataTable({

                    processing: true,

                    serverSide: true,

                    ajax: "{{ route('admin.payments') }}",
