...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">User/</span> Add Role</h4>
        <!-- Basic Layout & Basic with Icons -->
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-4">
                    <h5 class="card-header">Add Role</h5>
                    <form class="card-body" action="{{ route('admin.role.create') }}" method="POST" id="createFrm" enctype="multipart/form-data">
                                @csrf
                                <div class="row g-4">
                                    <div class="col-md-12">
                                        <div class="form-floating form-floating-outline">
                                            <input class="form-control" id="role" name="role" type="text">
                                            <label for="role">Role Name<b class="text-danger">*</b></label>
                                        </div>
                                        <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-role"></p>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating form-floating-outline mb-4">
                                            <textarea class="form-control h-px-75" id="description" name="description" type="text"></textarea>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success == true) {
                                ...
                                //notify
                                toastr.success("Role Management Created Successfully");
