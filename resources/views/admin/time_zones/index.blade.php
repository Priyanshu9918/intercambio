...
@section('content')
        <div class="content-wrapper">
            ...
            <h4 class="py-3 mb-4">
                ...
                <a href="{{route('admin.time_zones.create')}}" class="btn btn-primary">Add TimeZone</a>
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table" id="time_zones-datatable">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>TimeZone</th>
...
<script>
    $(document).ready(function(){
        ...
        if ($("#time_zones-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#time_zones-datatable').DataTable({

                processing: true,

                serverSide: true,

                ajax: "{{route('admin.time_zones')}}",
