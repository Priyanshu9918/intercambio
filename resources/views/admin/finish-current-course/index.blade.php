...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <h5 class="card-header">Course Approval</h5>
...
$(document).ready(function() {
    if ($("#support-datatable").length > 0) {
        ...
        var targetDt = $('#support-datatable').DataTable({
            ...
            ajax: "{{route('admin.finish-current-course')}}",
    ...
    $(document).on('change', '.statusSelect', function(event) {
        ...
        var type = $(this).val();
        var table = 'finish_courses';
        swal({
                // icon: "warning",
                type: "warning",
                title: "Are you sure you want to confirm the course approval action?",
                text: "",
                dangerMode: true,
            ...
            function(e) {
                if (e == true) {
                    $.ajax({
                        type: 'POST',
                        url: "{{route('admin.status-action2')}}",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            'id': id,
                            'table_name': table,
