...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Admin/</span> Edit ZipCode </h4>
        <!-- Basic Layout & Basic with Icons -->
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-4">
                    <h5 class="card-header">Edit Zipcode</h5>
                    <form class="card-body" action="{{ route('admin.zipcode.edit',['id'=>base64_encode($zipcode->id)]) }}" method="POST" id="editFrm" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-4">
                            <div class="col-md-12">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" id="zipcode" name="zipcode" class="form-control" value="{{$zipcode->zipcode ?? ''}}" placeholder="user-name">
        ...
        $(document).on('click', '#cancelButton', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location = "{{ url('/') }}" + "/admin/zipcode";
                }
            });
        });
    });
