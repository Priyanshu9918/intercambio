...
@section('content')
        <div class="content-wrapper">
            ...
            <h4 class="py-3 mb-4">
                ...
                <a href="{{route('admin.zipcode.create')}}" class="btn btn-primary">Add ZipCode</a>

              </h4>
              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Zip Codes</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table" id="zipcode-datatable">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>ZipCode</th>
...
<script>
    $(document).ready(function(){
        ...
        if ($("#zipcode-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#zipcode-datatable').DataTable({

                processing: true,

                serverSide: true,

                ajax: "{{route('admin.zipcode')}}",
