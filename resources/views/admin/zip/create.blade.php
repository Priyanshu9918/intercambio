...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Admin/</span>Zip Code</h4>
        <!-- Basic Layout & Basic with Icons -->
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-4">
                    <h5 class="card-header">Zip Code</h5>
                    <form class="card-body" action="{{ route('admin.zipcode.create') }}" method="POST" id="createFrm" enctype="multipart/form-data">
                        @csrf
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success == true) {
                                ...
                                //notify
                                toastr.success("ZipCode Created Successfully");
