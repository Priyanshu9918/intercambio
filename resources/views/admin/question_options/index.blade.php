...
@section('content')
        <div class="content-wrapper">
            ...
            <h4 class="py-3 mb-4">
                <a href="{{route('admin.question_options.create')}}" class="btn btn-primary">Create</a>
              </h4>
              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Question Option Master</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table" id="question_options-datatable">
                    <thead>
                      <tr>
                        <th>#</th>
                        {{-- <th>Question</th> --}}
...
<script>
    $(document).ready(function(){
        ...
        if ($("#question_options-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#question_options-datatable').DataTable({

                processing: true,

                serverSide: true,

                ajax: "{{route('admin.question_options')}}",
