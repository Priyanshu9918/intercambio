...
@section('content')
        <div class="content-wrapper">
            ...
            <h4 class="py-3 mb-4">
                ...
                <a href="{{route('admin.email.create')}}" class="btn btn-primary">Add Email Template </a>
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table" id="email-datatable">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>title</th>
...
<script>
    $(document).ready(function(){
        ...
        if ($("#email-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#email-datatable').DataTable({

                processing: true,

                serverSide: true,

                ajax: "{{route('admin.email')}}",
