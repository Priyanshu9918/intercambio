...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Admin/</span> State</h4>
        <!-- Basic Layout & Basic with Icons -->
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-4">
                    <h5 class="card-header">State</h5>
                    <form class="card-body" action="{{ route('admin.state.create') }}" method="POST" id="createFrm" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" id="short_name" name="short_name" class="form-control">
                                    <label for="short_name">Abbreviation<b class="text-danger">*</b></label>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    ...
                                    <label for="state_name">State Name<b class="text-danger">*</b></label>
                                </div>
                                <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-state_name"></p>
                            </div>

                            @php
                            $timezone = DB::table('time_zones')->get();
                        @endphp
                        <div class="col-md-12">
                            ...
                            <label class="form-label" for="state_id">Select TimeZone<b class="text-danger">*</b></label>
