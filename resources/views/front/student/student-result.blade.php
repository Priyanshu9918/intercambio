                    ...
                    <div class="col-xl-7 col-lg-8 col-md-10">
                        <div class="account-wrap">
                            ...
                            <div class="account-main">
                                ...
                                <p style="color: #000000a8;font-size: 13px;line-height: 20px;" class="text-center">You're being redirected to the Group Classes view where you can select from them as per your preference.</p>
                                ...
                                <div class="container d-flex">
                                    <div class="account-form-button col-4 mx-auto ">
                                            <a href="{{url('/student-pairing-control1')}}" class="btn btn-primary mr-2">Group Class</a>
                                    </div>
                                    <div class="account-form-button col-4 mx-auto ">
                                            <a href="{{url('/student-pairing-control')}}" class="btn btn-primary">One To One Class</a>
                                    </div>
                                </div>
