    ...
    <div class="col-xl-7 col-lg-8 col-md-9">
        <div class="account-wrap">
            <div class="account-main">
                ...
                <p style="margin-top: -10px">Please select the days and times you are available for classes. Please make sure you are
                ...
                <form action="{{ route('front.student.student-time-scheduling', ['id' => $students->user_id]) }}"
                            ...
                            <div class="account-form-item mb-20">
                                <div class="account-form-condition m-0">
                                    <label class="condition_label text-black fw-semibold">Monday
                                        <input type="checkbox" name="day[]" value="Monday" class="day-checkbox"
                                ...
                                <div class="account-form-input">
                                    <input type="time" name="time_from[]" value="{{ $data->time_from ?? '' }}"
                                        class="timepickers" placeholder="From" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="account-form-item mb-20">
                                ...
                                <div class="account-form-input">
                                    <input type="time" name="time_to[]" value="{{ $data->time_to ?? '' }}"
                                        class="timepickers" placeholder="To" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="account-form-item mb-20">
                                <div class="account-form-condition m-0">
                                    <label class="condition_label text-black fw-semibold">
                                        Tuesday
                                        <input type="checkbox" name="day[]" value="Tuesday" class="day-checkbox"
                                            @if ($data1 != null && $data1->day == 'Tuesday' ?? '') checked @endif>
                                        <span class="check_mark"></span>
                                    </label>
                                </div>
                                <div class="account-form-input">
                                    <input type="time" name="time_from[]" value="{{ $data1->time_from ?? '' }}"
                                        class="timepickers" placeholder="From">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="account-form-item mb-20">
                                ...
                                <div class="account-form-input">
                                    <input type="time" name="time_to[]" value="{{ $data1->time_to ?? '' }}"
                                        class="timepickers" placeholder="To ">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="account-form-item mb-20">
                                <div class="account-form-condition m-0">
                                    <label class="condition_label text-black fw-semibold">Wednesday
                                        <input type="checkbox" name="day[]" value="Wednesday" class="day-checkbox"
                                            @if ($data2 != null && $data2->day == 'Wednesday') checked @endif>
                                        <span class="check_mark"></span>
                                    </label>
                                </div>
                                <div class="account-form-input">
                                    <input type="time" name="time_from[]" value="{{ $data2->time_from ?? '' }}"
                                        class="timepickers" placeholder="From">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="account-form-item mb-20">
                                ...
                                <div class="account-form-input">
                                    <input type="time" name="time_to[]" value="{{ $data2->time_to ?? '' }}"
                                        class="timepickers" placeholder="To ">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="account-form-item mb-20">
                                <div class="account-form-condition m-0">
                                    <label class="condition_label text-black fw-semibold">Thursday
                                        <input type="checkbox" name="day[]" value="Thursday" class="day-checkbox"
                                            @if ($data3 != null && $data3->day == 'Thursday') checked @endif>
                                        <span class="check_mark"></span>
                                    </label>
                                </div>
                                <div class="account-form-input">
                                    <input type="time" name="time_from[]" value="{{ $data3->time_from ?? '' }}"
                                        class="timepickers" placeholder="From">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="account-form-item mb-20">
                                ...
                                <div class="account-form-input">
                                    <input type="time" name="time_to[]" value="{{ $data3->time_to ?? '' }}"
                                        class="timepickers" placeholder="To ">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="account-form-item mb-20">
                                <div class="account-form-condition m-0">
                                    <label class="condition_label text-black fw-semibold">Friday
                                        <input type="checkbox" name="day[]" value="Friday" class="day-checkbox"
                                            @if ($data4 != null && $data4->day == 'Friday') checked @endif>
                                        <span class="check_mark"></span>
                                    </label>
                                </div>
                                <div class="account-form-input">
                                    <input type="time" name="time_from[]" value="{{ $data4->time_from ?? '' }}"
                                        class="timepickers" placeholder="From">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="account-form-item mb-20">
                                ...
                                <div class="account-form-input">
                                    <input type="time" name="time_to[]" value="{{ $data4->time_to ?? '' }}"
                                        class="timepickers" placeholder="To ">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="account-form-item mb-20">
                                <div class="account-form-condition m-0">
                                    <label class="condition_label text-black fw-semibold">Saturday
                                        <input type="checkbox" name="day[]" value="Saturday" class="day-checkbox"
                                            @if ($data5 != null && $data5->day == 'Saturday') checked @endif>
                                        <span class="check_mark"></span>
                                    </label>
                                </div>
                                <div class="account-form-input">
                                    <input type="time" name="time_from[]" value="{{ $data5->time_from ?? '' }}"
                                        class="timepickers" placeholder="From">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="account-form-item mb-20">
                                ...
                                <div class="account-form-input">
                                    <input type="time" name="time_to[]" value="{{ $data5->time_to ?? '' }}"
                                        class="timepickers" placeholder="To">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="account-form-item mb-20">
                                <div class="account-form-condition m-0">
                                    <label class="condition_label text-black fw-semibold">Sunday
                                        <input type="checkbox" name="day[]" value="Sunday" class="day-checkbox"
                                            @if ($data6 != null && $data6->day == 'Sunday') checked @endif>
                                        <span class="check_mark"></span>
                                    </label>
                                </div>
                                <div class="account-form-input">
                                    <input type="time" name="time_from[]" value="{{ $data6->time_from ?? '' }}"
                                        class="timepickers" placeholder="From">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="account-form-item mb-20">
                                ...
                                <div class="account-form-input">
                                    <input type="time" name="time_to[]" value="{{ $data6->time_to ?? '' }}"
                                        class="timepickers" placeholder="To">
                                </div>
                            </div>
                        </div>
