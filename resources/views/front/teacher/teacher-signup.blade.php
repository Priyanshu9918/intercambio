                    ...
                    <div class="col-xl-7 col-lg-8 col-md-10">
                        <div class="account-wrap">
                            <div class="account-main">
                                ...
                                <form action="{{ route('teacher.teacher-signup-register', ['id' => $teachers->id]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <div class="account-form-input">
                                                    <input type="text" placeholder="Enter First name" value="{{$teachers->name ?? ''}}" name="name">
                                        ...
                                        <div class="col-md-6">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <div class="account-form-input">
                                                    <input type="text" placeholder="Enter Last Name" value="{{$teachers->l_name ?? ''}}" name="l_name">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <select name="here_about_us" class="js-example-basic-singlee"
                                                    style="display: none;" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <div class="account-form-input">
                                                    <input type="text" placeholder="Enter Mobile Phone" name="phone" value="{{$teachers1->phone ?? ''}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <div class="account-form-input">
                                                    <input type="date" placeholder="" name="birthday" value="{{$teachers1->birthday ?? ''}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <select name="gender" class="js-example-basic-singlee"
                                                    style="display: none;" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <div class="account-form-input">
                                                    <input type="text" placeholder="Enter Street Address" name="address" value="{{$teachers1->address ?? ''}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <div class="account-form-input">
                                                    <input type="text" placeholder="Enter City" name="city" value="{{$teachers1->city ?? ''}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <select name="state" class="js-example-basic-singlee"
                                                    style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <div class="account-form-input">
                                                    <input type="text" placeholder="Enter Zip Code" name="zip" value="{{$teachers1->zip ?? ''}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <select name="class_teaching_type" class="js-example-basic-singlee"
                                                    style="display: none;" id="class_type">
                                        ...
                                        <div class="col-md-6" id="type_pre">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <select name="class_type_preference" class="js-example-basic-singlee"
                                                    style="display: none;" id="type_pre1">
                                                    <option value="" >Select type</option>
                                        ...
                                        <div class="col-md-6" id="vol_loc">
                                            <div class="account-form-item mb-20">
                                                ...
                                                <select name="voluntee_location" class="js-example-basic-singlee"
                                                    style="display: none;" >
                                                    <option value="">Select type</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" id="loc_com">
                                            <div class="account-form-item mb-20 contact-form-input">
                                                ...
                                                <textarea name="location_comment" id="loc_com1"> {{ $teachers1->location_comment ?? '' }} </textarea>
                                        ...
                                        <div class="col-md-12">
                                            <div class="account-form-item mb-20 contact-form-input">
                                                <div class="account-form-label">
                                                    <label>Why would you like to volunteer for Intercambio?<span class="text-danger">*</span></label>

                                                </div>
                                                <textarea name="voluntee_for_intercombio">{{$teachers1->voluntee_for_intercombio ?? ''}}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            <div class="account-form-item mb-20 contact-form-input">
                                                ...
                                                <textarea name="other_info"> {{$teachers1->other_info ?? ''}} </textarea>
