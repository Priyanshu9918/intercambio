...
<div class="col-xl-9 col-lg-9 col-md-9">
    <div class="account-wrap">
        <div class="account-main">
            ...
            @if($group_check->class_type_preference != 'Group Classes')
            <p class="mb-0">Email for tech support : <a href="mailto:volunteer@intercambio.org" class="text-primary">volunteer@intercambio.org</a></p>
            <p>Link to tech support docs : <a href="https://intercambio.org/resource-hub" class="text-primary">Click here</a></p>
            <div class="accordion mt-3" id="accordionExample">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button collapsed py-2"
                            style="    background-color: #70a943; color: #fff;" type="button" data-bs-toggle="collapse"
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            <form class="card-body" action="{{ route('teacher.support') }}" method="POST" id="createFrm"
                                ...
                                <div class="account-form-item mb-15">
                                    ...
                                    <div class="account-form-input-pass">
                                        <div class="">
                                            <input type="radio" id="cancel1" name="cancel"
                                                value="I wish to stop teaching">
                                            <label for="cancel1">I wish to stop teaching</label><br>
                                            <input type="radio" id="cancel2" name="cancel"
                                                value="I’d like to work with a different student">
                                            <label for="cancel2">I’d like to work with a different student</label><br>
                                            <input type="radio" id="cancel3" name="cancel"
                                                value="My student doesn’t want to meet anymore – I’d like a new student">
                                            <label for="cancel3">My student doesn’t want to meet anymore – I’d like a
                                                new student</label>
                                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="conbox">
                    ...
                    @if($group_check->class_teaching_type == 'Online') <li><a href="mailto:online@intercambio.org"  style="color:#118fac;font-weight: 500;">online@intercambio.org</a></li> @else <li><a href="mailto:volunteer@intercambio.org"  style="color:#118fac;font-weight: 500;">volunteer@intercambio.org</a></li> @endif
                </div>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <p class="mb-0">Please email <a href="mailto:volunteer@intercamio.org" style="color:blue;">volunteer@intercamio.org</a> if you have any questions about your class or need any additional resources!</a></p>
            @endif
            ...
            <div class="modal-body">
                <div class=" mb-0 text-center">
                    <div class="course_details-meta flex-wrap ">
                        <div class=" flex-wrap">
                            <span class="d-flex justify-content-end fs-4" style="cursor: pointer;" id="cl_sup">&times;</span>
                            <h5 class="text-center">Your match has ended with Student.</h5>
                            <p>An Intercambio Team Member will be in contact with you soon about next steps. Please email <a style="color:blue;" href="mailto:online@intercambio.org">online@intercambio.org</a> if you have any questions!</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.success1 == false) {
                $('#error-cancel').html('Currently! You are not paired up with any student');
            }
