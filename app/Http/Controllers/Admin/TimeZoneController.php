...
class TimeZoneController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            $user = DB::table('time_zones')->orderBy('id','DESC')->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/time_zones/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.time_zones.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        {
            return view('admin.time_zones.create');
        }
        $rules = [
            'timezone' => ['required', 'regex:/^[a-zA-Z\s]+$/'],
            'zip_id' => 'required',
        ];
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $time_zones  = DB::table('time_zones')->where('id',$time_zones_id)->first();

            return view('admin.time_zones.edit',compact('time_zones'));
        }
        ...
        try{
            ...
            DB::table('time_zones')->where('id',$time_zones_id)->update($data);
